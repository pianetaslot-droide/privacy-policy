...
const products = [
  { id: 1, name: '日式手工陶瓷杯', category: 'kitchen', icon: '🍵', price: 39.90, originalPrice: 59.90, stock: 120, featured: true, isNew: false, description: '采用传统手工拉坯工艺，温润如玉的釉面触感，容量约300ml，适合日常饮茶和咖啡。', detail: '这款日式手工陶瓷杯采用高温烧制，釉面光滑细腻，手感温润。每一只杯子都经过匠人精心打磨，独一无二。可微波炉加热，可洗碗机清洗。', badge: '热卖',
    images: ['https://images.unsplash.com/photo-1556909114-44e3e70034e2?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1530968033775-2c92736b131e?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?w=600&h=600&fit=crop&auto=format'] },
  { id: 2, name: '北欧风不锈钢刀具套装', category: 'kitchen', icon: '🔪', price: 168.00, originalPrice: 238.00, stock: 45, featured: true, isNew: false, description: '德国工艺不锈钢锻造，包含主厨刀、切片刀、水果刀、剪刀及刀座，一套满足全部需求。', detail: '采用德国4116高碳不锈钢，硬度达到HRC56-58，锋利持久。人体工学手柄设计，握持舒适不易疲劳。配备实木刀座，安全收纳。', badge: '特惠',
    images: ['https://images.unsplash.com/photo-1593618998160-e34014e67546?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1566454419290-57a0589c9b17?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1618802400929-e00e7249aed7?w=600&h=600&fit=crop&auto=format'] },
  { id: 3, name: '珐琅彩搪瓷炖锅', category: 'kitchen', icon: '🍲', price: 259.00, originalPrice: 359.00, stock: 30, featured: false, isNew: true, description: '精铸铁胎搪瓷锅，均匀导热锁住营养，适用于煲汤、炖菜、焖饭，明火电磁炉通用。', detail: '精选优质铸铁铸造，外层高温珐琅工艺，内层哑光黑色搪瓷。锅盖内侧雨点设计，水蒸气循环滴落，让食物更加鲜美多汁。', badge: '新品',
    images: ['https://images.unsplash.com/photo-1585515320310-259814833e62?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1622973536968-3ead9e780960?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1556909172-89cf0b24bf53?w=600&h=600&fit=crop&auto=format'] },
  { id: 4, name: '竹木砧板三件套', category: 'kitchen', icon: '🪵', price: 78.00, originalPrice: null, stock: 200, featured: false, isNew: false, description: '天然整竹制作，三种尺寸满足不同需求，生熟分开更健康。', detail: '采用5年以上成熟楠竹，经过碳化处理，防霉防裂。大中小三种规格，分别适用于切肉、切菜和切水果。',
    images: ['https://images.unsplash.com/photo-1606760227091-3dd870d97f1d?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1615484477778-ca3b77940c25?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1594980596870-8aa52a78571e?w=600&h=600&fit=crop&auto=format'] },
  { id: 5, name: '全棉四件套（云朵白）', category: 'bedroom', icon: '🛏️', price: 299.00, originalPrice: 459.00, stock: 60, featured: true, isNew: false, description: '60支长绒棉面料，亲肤柔软，包含被套、床单和两个枕套，适合1.5/1.8米床。', detail: '甄选新疆长绒棉，60支高密度织造，面料细腻光滑如丝绸般触感。活性印染工艺，色牢度高不掉色。拉链隐藏设计，美观大方。', badge: '爆款',
    images: ['https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1629140727571-9b5c6f6267b4?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1616627988170-9e5b3d98e2db?w=600&h=600&fit=crop&auto=format'] },
  { id: 6, name: '记忆棉护颈枕', category: 'bedroom', icon: '💤', price: 129.00, originalPrice: 199.00, stock: 80, featured: true, isNew: false, description: '慢回弹太空记忆棉，根据体温和压力自动贴合颈椎曲线，缓解颈部疲劳。', detail: '采用进口记忆棉材料，密度80D，回弹时间3-5秒。人体工学蝶形设计，高低两侧适应不同睡姿。外套可拆洗，透气竹纤维面料。', badge: '好评如潮',
    images: ['https://images.unsplash.com/photo-1592789705501-f9ae4278a9e9?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1631157769361-2f4b9c8e7e0a?w=600&h=600&fit=crop&auto=format'] },
  { id: 7, name: '法兰绒加厚毛毯', category: 'bedroom', icon: '🧶', price: 89.00, originalPrice: 139.00, stock: 100, featured: false, isNew: true, description: '双面法兰绒材质，柔软蓬松保暖性强，冬季沙发毯午睡毯皆宜，多色可选。', detail: '380克加厚法兰绒，双面细腻触感。采用活性印染，不起球不掉色。适合空调房、午休、追剧时使用。',
    images: ['https://images.unsplash.com/photo-1580301762395-21ce6d5d3027?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1616486029423-aaa4789e8c9a?w=600&h=600&fit=crop&auto=format'] },
  { id: 8, name: '智能感应皂液器', category: 'bathroom', icon: '🧴', price: 69.00, originalPrice: 99.00, stock: 150, featured: false, isNew: true, description: '红外自动感应出泡，无需接触更卫生，USB充电一次续航3个月，泡沫绵密细腻。', detail: '采用高灵敏红外传感器，伸手即出泡。内置高品质泡沫泵芯，一按即出绵密泡沫。IPX4防水等级，放在洗手台无忧。', badge: '新品',
    images: ['https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1620626011761-996317b8d101?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1607006483009-c9a0807e5e0c?w=600&h=600&fit=crop&auto=format'] },
  { id: 9, name: '日式天然硅藻泥地垫', category: 'bathroom', icon: '🧽', price: 58.00, originalPrice: 79.00, stock: 90, featured: true, isNew: false, description: '天然硅藻土材质，踩上去3秒速干吸水，防滑防霉，简约素色设计百搭浴室。', detail: '采用天然硅藻土制作，微孔结构超强吸水。表面经过防滑处理，湿脚踩上去也不打滑。不发霉不变味，打理方便。',
    images: ['https://images.unsplash.com/photo-1620626011761-996317b8d101?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=600&h=600&fit=crop&auto=format'] },
  { id: 10, name: '旋转置物架（免钉）', category: 'bathroom', icon: '🗄️', price: 45.00, originalPrice: null, stock: 200, featured: false, isNew: false, description: '360度旋转设计，免打孔安装，四层收纳空间，浴室厨房桌面均可使用。', detail: '食品级PP材质，安全无毒。独特旋转设计，取用方便。免打孔底座，不伤墙面不留痕。防水防潮，易清洁。',
    images: ['https://images.unsplash.com/photo-1600566752229-250ed79470f8?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1595515106969-1ce29566ff1c?w=600&h=600&fit=crop&auto=format'] },
  { id: 11, name: '北欧风干花花瓶套装', category: 'decor', icon: '🏺', price: 88.00, originalPrice: 128.00, stock: 55, featured: true, isNew: false, description: '磨砂玻璃花瓶配永生干花，自然文艺范，客厅卧室书房餐桌百搭装饰。', detail: '手工磨砂工艺玻璃瓶，搭配精选天然干花花束。无需打理浇水，常年美丽绽放。多种花色可选，为空间增添温馨氛围。', badge: '颜值担当',
    images: ['https://images.unsplash.com/photo-1490750967868-88aa4f44baee?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1596438459194-f275f413d6ff?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1508610048659-a06b669e3321?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1578500494198-246f612d3b3d?w=600&h=600&fit=crop&auto=format'] },
  { id: 12, name: '创意小夜灯（月球）', category: 'decor', icon: '🌙', price: 49.00, originalPrice: 79.00, stock: 120, featured: false, isNew: true, description: '3D打印月球表面纹理，触控调光三色可切换，USB充电，适合床头氛围灯。', detail: 'NASA月球数据3D打印，真实还原月球表面纹理。三种色温（暖白/暖黄/冷白）触控切换。USB充电8小时续航，磁吸底座可悬浮展示。',
    images: ['https://images.unsplash.com/photo-1532210317995-cc56d90177d9?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1507400492013-162706c8c05e?w=600&h=600&fit=crop&auto=format'] },
  { id: 13, name: '棉麻折叠收纳箱（3只装）', category: 'storage', icon: '📦', price: 55.00, originalPrice: 85.00, stock: 180, featured: true, isNew: false, description: '加厚棉麻面料，钢架支撑不塌陷，可折叠不占空间，适合衣柜杂物整理。', detail: '外层采用日式棉麻面料，质感优良。内置镀锌钢丝骨架，承重力强。不用时可完全折叠，厚度仅3cm。防尘盖设计，保持衣物干净。', badge: '实用之选',
    images: ['https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1597348989645-e71e0e647cba?w=600&h=600&fit=crop&auto=format'] },
  { id: 14, name: '桌面文具收纳盒', category: 'storage', icon: '✏️', price: 35.00, originalPrice: null, stock: 200, featured: false, isNew: true, description: '多格分区设计，笔筒+手机架+小物件收纳一体，简约白色百搭桌面。', detail: '环保ABS材质，圆角设计安全无毛刺。多功能分区，笔筒、便签区、手机支架、杂物格一应俱全。底部防滑垫，稳固不移位。',
    images: ['https://images.unsplash.com/photo-1544816155-12df9643f363?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=600&h=600&fit=crop&auto=format'] },
  { id: 15, name: 'LED护眼台灯', category: 'lighting', icon: '💡', price: 158.00, originalPrice: 228.00, stock: 40, featured: false, isNew: true, description: '无频闪无蓝光危害，五档亮度三档色温，USB充电口，学习办公护眼之选。', detail: 'Ra>95高显色指数，真实还原色彩。无可视频闪技术，有效减少眼睛疲劳。触控面板操作，5档亮度×3档色温共15种光效。灯臂多角度调节，自由定位光源方向。', badge: '护眼推荐',
    images: ['https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1534073828943-f801091bb18c?w=600&h=600&fit=crop&auto=format'] },
  { id: 16, name: '复古实木小吊灯', category: 'lighting', icon: '🪔', price: 199.00, originalPrice: 299.00, stock: 25, featured: true, isNew: false, description: '日式原木灯罩+铁艺灯架，E27螺口通用灯泡，适合餐厅吧台走廊氛围照明。', detail: '精选橡木手工车削灯罩，纹理天然独特。铁艺灯架复古喷漆处理，哑光质感。E27标准螺口，兼容LED/钨丝/爱迪生灯泡。含1.5米可调节挂线。',
    images: ['https://images.unsplash.com/photo-1524484485831-a92ffc0de03f?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1543198126-a8ad8e47fb22?w=600&h=600&fit=crop&auto=format','https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=600&h=600&fit=crop&auto=format'] },
];
...
function renderProductImage(p, size) {
  size = size || 'card'; // 'card' | 'detail'
  if (p.images && p.images.length > 0) {
    const src = p.images[0];
    return `<img src="${src}" alt="${p.name}" loading="lazy" style="width:100%;height:100%;object-fit:cover" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><span style="display:none;width:100%;height:100%;align-items:center;justify-content:center;font-size:${size === 'detail' ? '10rem' : '4.5rem'}">${p.icon}</span>`;
  }
  return `<span style="font-size:${size === 'detail' ? '10rem' : '4.5rem'}">${p.icon}</span>`;
}

// 渲染详情页图片画廊缩略图
function renderGalleryThumbs(p) {
  if (!p.images || p.images.length <= 1) return '';
  return p.images.map((src, i) => `<div class="detail-gallery-thumb${i === 0 ? ' active' : ''}" onclick="switchGalleryImg(this, '${src}')"><img src="${src}" alt="${p.name} ${i+1}" style="width:100%;height:100%;object-fit:cover" onerror="this.style.display='none';this.parentElement.innerHTML='${p.icon}'"></div>`).join('');
}
